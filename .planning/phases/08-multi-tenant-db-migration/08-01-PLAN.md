...
must_haves:
  truths:
    ...
    - "All 18 tenant-scoped tables have company_id NOT NULL after backfill"
...
<task type="auto">
  <name>Task 2: Add backfill blocks to 009_multi_tenant.sql (seed company + all 18 tables + NOT NULL constraints)</name>
  <files>supabase/migrations/009_multi_tenant.sql</files>
  <action>
