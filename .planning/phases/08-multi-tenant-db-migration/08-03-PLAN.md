...
IMPORTANT: After executing BLOCK 12 in the Dashboard, immediately proceed to 08-04 to register the JWT hook. The application will be in a locked-out state between these two steps because current_company_id() returns NULL until the hook is registered.
</objective>
