...
<objective>
Build shopping cart page with quantity management and order creation with minimum amount validation.
...
<task type="auto">
  <name>Task 1: Create cart page with quantity management</name>
  <files>
    src/app/(dealer)/cart/page.tsx
    src/components/cart/cart-items.tsx
    src/components/cart/cart-summary.tsx
  ...
  <action>
    ...
    Note: The cart store (src/store/cart.ts) was already created in Plan 01-05.
...
<task type="auto">
  <name>Task 2: Create order validation and checkout page</name>
  <files>
    src/lib/validations/order.ts
    src/lib/actions/orders.ts
    src/app/(dealer)/checkout/page.tsx
